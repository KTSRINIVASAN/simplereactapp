  ...
  return (
    <div className='sidebar'> 
        ...
        <h3 className='sidebarTitle'>Compliance</h3>
            ...
            <li className='sidebarListItem'> <NavLink to='/compliance2/hitrust2' activeClassName ='active'> <  PaymentsIcon style={{color:'#fff'}} /> Hitrust</NavLink></li>
                <li className='sidebarListItem'> <NavLink to='/compliance2/tags2' activeClassName ='active'> <  PaymentsIcon style={{color:'#fff'}} />Tags</NavLink></li>
