...
const rows = [
  createData('CloudTrail Present and Logging', 'Fail', 350, 380, 360, '500$'),
  createData('CloudWatch Enabled and Logging', 'Fail',250, 280, 290, '500$'),
//   createData('Encrypted EBS Volumes', 'Pass',150, 175 ,170, '500$'),
  
//   createData('Ok', 'COST CODE A', 300, 330,  310, '500$'),
];

export default function Sk006table() {
  return (
    <>
