...
const rows = [
  createData('Restricted IAM Policies in Use', 'Fail', 350, 380, 360, '500$'),
  createData('S3 Bucket Access Control', 'Fail',250, 280, 290, '500$'),
  createData('S3 Bucket Policy', 'Pass',150, 175 ,170, '500$'),
  
//   createData('Ok', 'COST CODE A', 300, 330,  310, '500$'),
];

export default function ResAccesstable() {
  return (
    <>
