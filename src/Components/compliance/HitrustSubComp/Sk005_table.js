...
const rows = [
  createData('IAM Users should be avoided', 'Pass', 350, 380, 360, '500$'),
  createData('IAM Roles Present and Configured', 'Pass',250, 280, 290, '500$'),
//   createData('Encrypted EBS Volumes', 'Pass',150, 175 ,170, '500$'),
  
//   createData('Ok', 'COST CODE A', 300, 330,  310, '500$'),
];

export default function Sk005table() {
  return (
    <>
