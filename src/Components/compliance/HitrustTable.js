...
const rows = [
  createData('Inbound', 'Pass', 350, 380, 360, '500$'),
  createData('S3', 'Fail',250, 280, 290, '500$'),
  createData('Bound', 'Pass',150, 175 ,170, '500$'),
  createData('S4', 'Fail',510, 580,  520, '500$'),
//   createData('Ok', 'COST CODE A', 300, 330,  310, '500$'),
];

export default function Hitrusttable() {
  return (
    <>
